...
mod tests {
    ...
    fn evaluate_sets_fitness() {
        ...
        let ctx = Context::<i64, (), ()> { generation: 0, diversity: 0.0, stagnation: 0.0, normal: rand_distr::Normal::new(0.0_f32, cfg.sigma.get(0, cfg.max_generation)).unwrap(), config: &cfg, state: &None, pools: &pools, __: std::marker::PhantomData };
