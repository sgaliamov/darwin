...
Short, smart, elegant — but sane. Pattern matching, immutable state, functional/fluent style where readable.
...
_Module Organization_

- Keep `mod.rs` for declarations/reexports mainly;
- prefer `pub use crate::...` over `use super::...`,
- and reexport submodules as `pub use module::*;`.
- Do not add empty lines between uses and mods.
